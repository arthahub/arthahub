...
import { registerWithEmail, signInWithGoogle } from "../function/auth";
...
const RegisterPage = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            const user = await registerWithEmail(emailInputValue, passwordInputValue);
                            ...
                            <MainLayout>
                                <div className="min-h-[50vh] py-20 flex items-center justify-center">
                                    <div className="space-y-2">
                                        <form method="POST" onSubmit={(e) => submitHandler(e)} className="w-full lg:w-full 2xl:w-[50vh] relative" id="parent-form">
                                            ...
                                            <div className="w-full h-[50px] flex items-center rounded border text-[10px] 2xl:text-xs mt-[19px] overflow-hidden">
                                                <button type="button" className="w-full h-full flex items-center justify-center space-x-3 hover:bg-neutral-100 duration-150" onClick={googleHandler}>
